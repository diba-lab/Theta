...
% Define the block type and x-axis limits
...
% Define injection and state types
...
% Load running window theta data for selected states and block
...
% Load state ratios for selected block
